  ...
  return (
    ...
    <a href="/">
      ...
      {<div className='hidden lg:flex space-x-4'>
        <button className='btn btn-sm text-white hover:text-red-500 transition hidden' >{btnLoginText}</button>
        <button className='btn btn-sm bg-red-500 hidden' >{btnSignupText}</button>
      </div>}
